...
const config_filename = 'config_local.json'; //set config file name
...
helper.package_json = require(path.join(__dirname, '../../package.json')); //get release version of marbles from package.json
